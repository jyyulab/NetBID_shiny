...
For the tutorial of the online server [NetBIDshiny_runner](https://yulab-stjude.shinyapps.io/NetBID2_Runner/), users could check [tutorial4online](tutorial4online).
